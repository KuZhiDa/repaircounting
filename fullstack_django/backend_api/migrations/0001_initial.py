# Generated by Django 5.0.6 on 2025-03-25 20:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('calculation_type', models.CharField(max_length=100, verbose_name='Тип расчета')),
                ('input_data', models.JSONField(default=dict, verbose_name='Входные данные')),
                ('result_data', models.JSONField(default=dict, verbose_name='Результаты расчета')),
